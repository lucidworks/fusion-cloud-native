...
PROVIDER=gke
CLUSTER_NAME=gke_lw-sales_us-west1_lw-sales-us-west1
RELEASE=sanket
NAMESPACE=sanket
CHART_VERSION=5.1.0

MY_VALUES=""
MY_VALUES="$MY_VALUES --values gke_gke_lw-sales_us-west1_lw-sales-us-west1_sanket_fusion_values.yaml"
MY_VALUES="$MY_VALUES --values gke_gke_lw-sales_us-west1_lw-sales-us-west1_sanket_fusion_resources.yaml"
MY_VALUES="$MY_VALUES --values gke_gke_lw-sales_us-west1_lw-sales-us-west1_sanket_fusion_affinity.yaml"
