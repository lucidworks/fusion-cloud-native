...
```
./setup_f5_gke.sh -c <cluster_name> -p <gcp_project_id> -n <namespace> -z <zone> --create demo
```
...
+
```
./setup_f5_gke.sh -c <cluster> -p <project> -z <zone> -n <namespace> --create demo
```
+
--
...
```
./setup_f5_gke.sh -c <cluster> -p <project> -z <region-name> -n <namespace> --create multi_az
```
--
