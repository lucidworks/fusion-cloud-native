...
Once you're ready to build a Fusion cluster for production, please see the https://github.com/lucidworks/fusion-cloud-native/blob/master/Fusion_5_Survival_Guide_v0.2.pdf[Fusion 5 Survival Guide] PDF in this repo.
