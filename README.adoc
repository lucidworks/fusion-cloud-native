...
. Create an https://docs.aws.amazon.com/elasticloadbalancing/latest/application/introduction.html[Application Load Balancer^] that allows communication from port 80/443. You must include your nodes as the target group and the health checker should point to the port kubernetes is using.
