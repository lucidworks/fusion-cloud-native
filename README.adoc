...
The `--values` flag can be specified multiple times, each ponting to a different file. If a configuration property is specified in multiple files then the value from the latest file in the list will take priority.
