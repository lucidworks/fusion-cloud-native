...
In order for the Solr Metrics Dashboard to show the replication metrics, the replication_exporter_values.yaml file has to be passed to the helm install command to export extra metrics from solr.
