...
|=========================================================
|Version|Date|Notes
|5.3.5|2021-02-26|Fusion 5.3.5 release, see official https://doc.lucidworks.com/fusion/5.3/11250/fusion-5-3-5-release-notes[release notes]. For upgrades from previous versions of Fusion 5.0.x, see the {migration-guide}[Migration Guide].
