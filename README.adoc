...
|=========================================================
|Version|Date|Notes
|5.9.1|2023-29-05|Fusion 5.9.1 release, see official https://doc.lucidworks.com/fusion/5.9/ht2sax/fusion-5-9-1[release notes]. For upgrades from previous versions of Fusion 5.0.x, see the {migration-guide}[Migration Guide].
