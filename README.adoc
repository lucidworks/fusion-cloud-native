...
|=========================================================
|Version|Date|Notes
|5.4.4|2021-12-03|Fusion 5.4.3 release, see official https://doc.lucidworks.com/fusion/5.4/z3r8fr/fusion-5-4-4-release-notes[release notes]. For upgrades from previous versions of Fusion 5.0.x, see the {migration-guide}[Migration Guide].
