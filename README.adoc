...
* cluster_name _must_ point to an existing cluster
* eks_resource_group should be the default if you ran the aws configure command without giving the profile a name.

If you need the setup script to create the cluster, for example my_eks_cluster, and you have a profile of default and your namespace is cold-fusion, the script should be called as:
>>>>>>> b17763c271e6967131f44b9b79a6e1f518d07c63
````
