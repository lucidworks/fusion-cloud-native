...
|=========================================================
|Version|Date|Notes
|5.1.4|2020-06-18|Fusion 5.1.4 release, see official release notes: https://doc.lucidworks.com/fusion-server/5.0/release-notes/5.1.4-release-notes.html. For upgrades from previous versions of Fusion 5.0.x, see the https://github.com/lucidworks/fusion-cloud-native/tree/master/migrations[Migration Guide].
