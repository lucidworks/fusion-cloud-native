...
Also you can remove it manually using the AWS console: https://console.aws.amazon.com/iam/home?region=us-west-2#/policies , searching for `eksctl-<cluster-name>-alb-policy`.
