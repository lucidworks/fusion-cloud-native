...
|=========================================================
|Version|Date|Notes
|5.4.0|2021-04-23|Fusion 5.4.0 release, see official https://doc.lucidworks.com/fusion/5.4/11255/fusion-5-4-0-release-notes[release notes]. For upgrades from previous versions of Fusion 5.0.x, see the {migration-guide}[Migration Guide].
