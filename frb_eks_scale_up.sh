...
do
 ...
 echo "Executing aws elb register-instances-with-load-balancer --load-balancer-name a01d91c1be3e9440aa7056fa2dde1958 --instances $running_instance_id"
 aws elb register-instances-with-load-balancer --load-balancer-name a01d91c1be3e9440aa7056fa2dde1958 --instances $running_instance_id
done