...
This topic explains how to plan and execute a Fusion deployment at the scale you need.
...
Of course if you don't want to use Prometheus, simply pass `--prometheus false` to the script.
