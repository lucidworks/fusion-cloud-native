...
ifndef::env-github[]
image:https://raw.githubusercontent.com/lucidworks/fusion-cloud-native/DOCS-2152-F5-survival-guide/survival_guide/high-availability.png[]
endif::[]
...
Armed with a basic understanding of the Fusion 5 architecture and how the various microservices interact, let's move on to
ifdef::env-github[]
link:2_planning.adoc[planning your installation].
endif::[]
ifndef::env-github[]
link:2_planning.adoc[planning your installation].
endif::[]
