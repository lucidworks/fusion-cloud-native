...
In your custom values YAML file, at the end of the section for the ml-model-service, add a section for Milvus as shown below (assuming the name of your GPU nodepool is `gpu-nodepool`):
