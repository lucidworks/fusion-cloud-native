...
+
image:https://github.com/lucidworks/fusion-cloud-native/blob/DOCS-2152-F5-survival-guide/survival_guide/grafana-add-datasource.png?raw=true[]
...
+
image:https://github.com/lucidworks/fusion-cloud-native/blob/DOCS-2152-F5-survival-guide/survival_guide/grafana-import.png?raw=true[]
// end::grafana[]
