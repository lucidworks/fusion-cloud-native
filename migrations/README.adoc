...
The latest version of Fusion 5 is 5.2.0. The migration process varies depending on your current version of Fusion.

// tag::body[]

== Migrating from Fusion 5.1.4 to 5.2.0

There are no additional steps that need to be run to migrate from fusion 5.1.4 to 5.2.0. Simply following the link:https://doc.lucidworks.com/how-to/upgrade-fusion-with-helm3.html[Fusion upgrade instructions].
